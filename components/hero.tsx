...
export function Hero() {
  return (
    <section id="home" className="flex flex-col items-center justify-center text-center px-6 pt-[100px] pb-12 md:pb-20 md:min-h-screen relative overflow-x-hidden bg-white">
